...
# 06-158: UML      FEATURES-PROPERTIES


### 1. What Features and Properties are
...
**Features** (also named as **Properties**) in UML represent the **fundamental building blocks that define the characteristics and capabilities of model elements**.

They  describe ... :

* #### what an element ***has*** (properties) 
* #### what it can **do** (behavioural features).
...
- **Behavioural diagrams** - Use case, activity, sequence, and state machine diagrams
...
- **Behavioural features** - Define what an element can do or how it behaves
...
Standardised naming conventions are crucial for several reasons:
...
- **Knowedge preservation** - Naming conventions encode team knowledge
...
Packages organise features into logical groups:
...
- **Synchronisation** - Keeps code and models aligned
